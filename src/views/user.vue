<template>
    <div>
      <nv-head page-type="用户信息" :fix-head="true" :need-add="true" :show="false">
      </nv-head>
      <section class="userInfo">
        <img :src="user.avatar_url" class="u-img"><br/>
      ...
      <section class="topics">
        ...
        <div class="message" v-for="item in currentData">
          <section class="user">
            <router-link :to="{name: 'user', params: {logingname: item.author.loginname}}">
